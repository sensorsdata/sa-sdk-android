/*
 * Created by chenru on 2021/08/19.
...
public class DeferredDeepLinkHelper {
    public static void request(final Context context, final JSONObject jsonData, final SensorsDataDeferredDeepLinkCallback callBack, String url, final boolean isSaveDeepLinkInfo) {
                ...
                .callback(new HttpCallback.JsonCallback() {
                    ...
                    public void onAfter() {
                        if (isSaveDeepLinkInfo) {
                            ChannelUtils.saveDeepLinkInfo(context.getApplicationContext());
                        }
