> 根据《个人信息保护法》《网络安全法》《电信条例》《电信和互联网用户个人信息保护规定》等相关规定，监管侧进一步强化了关于完整隐私政策、数据收集合规说明、合规采集可配置功能选项等方面的要求。监管侧也会指定相关机构，针对上述重点进行滚动抽查，若未达标，存在APP被应用市场下架的潜在风险。为此，我们特别推荐您关注并升级到我们的Android SDK最新版本。
>
