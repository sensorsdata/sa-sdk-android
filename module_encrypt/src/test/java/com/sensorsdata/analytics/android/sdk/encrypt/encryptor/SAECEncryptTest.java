...
public class SAECEncryptTest {
    ...
    @Test
    public void encryptEvent() {
    }

    @Test
    public void asymmetricEncryptType() {
        SAECEncrypt ecEncrypt = new SAECEncrypt();
        Assert.assertEquals("EC", ecEncrypt.asymmetricEncryptType());
    }

    @Test
    public void encryptSymmetricKeyWithPublicKey() {
    }
}