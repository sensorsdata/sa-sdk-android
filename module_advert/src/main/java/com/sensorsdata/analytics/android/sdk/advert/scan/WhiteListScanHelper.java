        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    json.put("android_oaid", SAOaidHelper.getOAID(activity));
                    json.put("android_id", SAAdvertUtils.getAndroidId(activity));
                    json.put("android_imei", SAAdvertUtils.getIMEI(activity));
